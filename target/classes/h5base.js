    ...
    }), function ()
{
    ...
    function e(t, o)
    {
        ...
        {
            for (var a = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], r = this, c = 0, s = a.length; c < s; c++)
            {
                r[a[c]] = function (e, t)
                {
                    return function ()
    ...
    }, e.prototype.onTouchEnd = function (e)
    {
        ...
        {
            return e.timeStamp - r > 100 || o && window.top !== window && "input" === c ? (this.targetElement = null, !1) : (this.focus(u), this.sendClick(u, e), o && "select" === c || (this.targetElement = null, e.preventDefault()), !1);
        }
...
var historyUtils = {
    ...
    back: function ()
    {
        ...
        if (!n)
        {
            return this.add(t), window.location.href = "/", !1;
        }
...
!
    function ()
    {
        ...
        var mkzAjax = mkz.mkzAjax = function (e)
        {
            ...
            {
                for (var t = n(e).sort(), o = {}, i = 0; i < t.length; i++)
                {
                    o[t[i]] = e[t[i]];
                }
                return o
        ...
        {
            for (var e = mkz.readHistoryList, t = mkz.getLocalUread(), n = 0; n < t.length; n++)
            {
                for (var o = t[n].comic_id, i = t[n].read_time, a = 0; a < e.length; a++)
                {
                    e[a].comic_id == o && e[a].read_time >= i && (t.splice(n, 1), n -= 1);
                }
            }
        ...
        }, mkz.updateUread = function (e)
        {
            for (var t = {
                ...
                type: e.type,
                status: e.status
            }, n = mkz.getLocalUread(), o = 0; o < n.length; o++)
            {
                if (n[o].comic_id == e.comic_id)
                {
                    n.splice(o, 1);
                    break
                }
                    ...
                    $("img[data-src]:visible").each(function ()
                    {
                        ...
                        if (l && i.css("background", "url(" + l + ") center center / 32px 32px no-repeat"), c < a + r && c + s > a)
                        {
                            if (n)
                            {
                                ...
                                {
                                    if (new RegExp(d).test(i.attr("style")))
                                    {
                                        return !1;
                                    }
                                    i.attr("src", u).css({
                            ...
                            {
                                i.attr("src", p).removeAttr("data-src");
                            }
                            i.error(function ()
                            {
                                if (new RegExp(d).test(i.attr("style")))
