    ...
    Top = function ()
    {
        ...
        }, t.renderList = function (e)
        {
            ...
            }).then(function (e)
            {
                ...
                {
                    n = '<div class="rank-item clearfix"><a href="/' + i[a].comic_id + '"><img class="cover" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="' + i[a].cover + '!cover-200" alt="' + i[a].title + '"><div class="comic-item-info"><p class="comic-name">' + i[a].title + '</p><p class="comic-author">' + i[a].author_title + '</p><p class="comic-tip">' + i[a].feature + "</p></a>", i[a].amount ? n += '<p class="comic-click-count">月票：' + i[a].amount + "</p></div>" : i[a].read_count ? n += "ascension" == c || "latest" == c || "popular" == c ? '<p class="comic-click-count">周点击：' + i[a].read_count + "</p></div>" : '<p class="comic-click-count">总点击：' + i[a].read_count + "</p></div>" : i[a].collection_count && (n += '<p class="comic-click-count">总收藏：' + i[a].collection_count + "</p></div>"), n += '<div class="rank-tag">' + t.index++ + "</div>", t.container.append($(n))
                }
            }).fail(function ()
            {
                t.lock()
    ...
    Lists = function ()
    {
        ...
        }, t.renderList = function (e)
        {
            ...
            }).then(function (e)
            {
                ...
                {
                    a = '<li class="comic-item">          <a href="/' + n[c].comic_id + '/"><img class="cover" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="' + n[c].title + '" data-src="' + n[c].cover + '!cover-200"></a>          <div class="comic-info-box">          <p class="comic-name">' + n[c].title + '</p>          <p class="comic-tip">更新至' + n[c].chapter_num + "话</p>          </div>          </li>", t.container.append($(a));
                }
                i.resolve(e)
            }).fail(function ()
            {
    ...
    Search = function ()
    {
        ...
        }, e.rendActiveCon = function (t, i)
        {
            ...
            if (a > 0)
            {
                ...
                for (var o = 0; o < a; o++)
                {
                    c += '<div class="search-active-item" data-keyword="' + i + '" data-cid="' + t[o].comic_id + '"><p class="comic-name">' + t[o].title.replace(n, function (t)
                    {
        ...
        }, e.initInput = function ()
        {
            ...
            }), e.input.on("input", t(function ()
            {
                ...
                if (!t)
                {
                    return 0 != $(".search-result").length && $(".search-result").show(), !1;
                }
        ...
        {
            for (var i = e.getHistory(), n = "", a = 0; a < i.length; a++)
            {
                n = '<p class="search-history-item clearfix"><a href="/spotlight?keyword=' + i[a] + '"><span class="search-his-txt">' + i[a] + '</span></a><span class="del-btn"><i class="ift-searchlist_clearo"></i></span></p>', e.historyList.append($(n));
            }
        ...
        }, e.bindSigleDel = function ()
        {
            ...
            {
                for (var t = $(this), i = e.getHistory(), n = t.prev().find(".search-his-txt").text(), a = 0; a < i.length; a++)
                {
                    if (i[a] === n)
                    {
                        i.splice(a, 1);
...
$("#mainView").click(function ()
{
    ...
    {
        $(".bottom-tool-bar").css("bottom", "0px");
    }
